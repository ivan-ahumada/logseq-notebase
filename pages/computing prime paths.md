...
## **NOTE**: `!` in a path table means to not consider that node because it doesn't have outgoing edges. Also used if a path would repeat nodes on a further extend.
##
